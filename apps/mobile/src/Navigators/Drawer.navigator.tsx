...
import ListPostMoScreen from "../Entities/PostMo/List.postMo.screen";
import ShowPostMoScreen from "../Entities/PostMo/Show.postMo.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListPostMoScreen"
            component={ListPostMoScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowPostMoScreen"
          component={ShowPostMoScreen}
          options={screenOptions}
        />
